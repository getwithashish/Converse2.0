    ...
    <div className="flex h-screen">
      ...
      <div className="relative flex w-full flex-grow flex-col overflow-hidden bg-gradient-to-r from-gray-950 to-gray-900 p-5">
        <div className="flex flex-grow flex-col overflow-hidden p-5">
          <div
            className="text-md pt-20 lg:pt-10 text-left font-semibold tracking-tight md:text-lg lg:text-xl"
            ref={secRef}
          >
            Chat with Converse DataSage
          </div>
          ...
          <div className="flex items-center justify-between p-5">
            ...
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className={`ml-4 h-6 w-6 cursor-pointer text-gray-500 ${isLoading ? 'pointer-events-none opacity-50' : ''}`}
